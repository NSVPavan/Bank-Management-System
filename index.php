...
<div class="row w-100" >
  ...
  <h4 class="display-5">Welcome to Allahabad Bank</h4>
     ...
     ?></p>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-2 rounded-1 shadowBlack" data-ride="carousel" >
          ...
          <div class="carousel-item">
            <img class="d-block w-100" src="images/2.jpeg" alt="Second slide" style="max-height: 250px">
          </div>
          <div class="carousel-item">
...
<div class="col">
    <div class="row" style="padding: 22px;padding-top: 0">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/transfer1.jpeg" alt="Card image cap" style="max-height: 155px;min-height: 155px">
        <div class="card-body">
    ...
    <div class="row" style="padding: 22px">
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/bell1.jpeg" style="max-height: 155px;min-height: 155px" alt="Card image cap">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/contacts1.jpeg" alt="Card image cap" style="max-height: 155px;min-height: 155px">
        <div class="card-body">
