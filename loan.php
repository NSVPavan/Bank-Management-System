...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
 <a class="navbar-brand" href="#">
   ...
   <!--  <i class="d-inline-block  fa fa-building fa-fw"></i> --><?php echo "Allahabad Bank"; ?>
  </a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active"> <a class="nav-link" href="loan.php">Loans</a></li>
  ...
  <div class="card-body">
      <form method="POST">
          <div class="alert alert-success w-50 mx-auto">
            <h5>Pay Loan</h5>
            <input type="text" name="otherNo" class="form-control " placeholder="Enter Bank Account number" required>
      ...
      <?php if (isset($_POST['get'])) 
      {
        ...
        $array3 = $con->query("select * from userAccounts where accountNo = '10054777'");
        {
          ...
          { $row2 = $array2->fetch_assoc();
            ...
            //       </form>
            //     </div>";
            echo "<div class='alert alert-success w-50 mx-auto'>Account No. $_POST[otherNo] is not Bank Account.</div>";
    ...
    //   echo "<script>alert('Transfer is not possible');window.location.href='loan.php'</script>";
    // }
    if (isset($_POST['transfer']))
    {
      ...
      setBalance($amount,'debit',$userData['accountNo']);
      // makeTransaction('transfer',$amount,$_POST['otherNo']);
      sendLoan('transfer',$amount,$bankAccNo);
      echo "<script>alert('Transfer Successfull');window.location.href='loan.php'</script>";
    }
